...
-- Copiando dados para a tabela cmas.votos_suas: ~4 rows (aproximadamente)
...
CREATE DATABASE IF NOT EXISTS `selecao` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `selecao`;

-- Copiando estrutura para tabela selecao.app
CREATE TABLE IF NOT EXISTS `app` (
  ...
  `pos_graduacao` varchar(30) DEFAULT NULL,
  `mestrado` varchar(3) DEFAULT NULL,
  `doutorado` varchar(3) DEFAULT NULL,
  `experiencia_tempo` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela selecao.app: ~1 rows (aproximadamente)
INSERT INTO `app` (`id`, `nome`, `email`, `cpf`, `rg`, `endereco`, `datanasc`, `telefone`, `pos_graduacao`, `mestrado`, `doutorado`, `experiencia_tempo`) VALUES
	(7, 'Glaison Queiroz', 'glaison26.queiroz@gmail.com', '69551022653', 'm4662097', 'Rua da Intendencia 316 centro sabara', '1969-10-26', '(31) 98426-2508', '1 (uma)', 'Sim', 'Sim', '4 anos / 1.460 dias');

-- Copiando estrutura para tabela selecao.en_nm
CREATE TABLE IF NOT EXISTS `en_nm` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `endereco` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `datanasc` date DEFAULT NULL,
  `telefone` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `curso_tecnico` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `graduacao` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `pos_graduacao` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `experiencia_tempo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela selecao.en_nm: ~1 rows (aproximadamente)
INSERT INTO `en_nm` (`id`, `nome`, `email`, `cpf`, `rg`, `endereco`, `datanasc`, `telefone`, `curso_tecnico`, `graduacao`, `pos_graduacao`, `experiencia_tempo`) VALUES
	(2, 'Glaison Queiroz', 'glaison26.queiroz@gmail.com', '69551022653', 'm4662097', 'Rua da Intendencia 316 centro sabara', '1968-10-26', '(31) 98426-2508', 'Sim', 'Sim', 'Não', '4 anos / 1.460 dias');

-- Copiando estrutura para tabela selecao.ss_pp
CREATE TABLE IF NOT EXISTS `ss_pp` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `cpf` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `datanasc` date DEFAULT NULL,
  `telefone` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `pos_graduacao` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `mestrado` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `doutorado` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `experiencia_tempo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela selecao.ss_pp: ~1 rows (aproximadamente)
INSERT INTO `ss_pp` (`id`, `nome`, `email`, `cpf`, `rg`, `endereco`, `datanasc`, `telefone`, `pos_graduacao`, `mestrado`, `doutorado`, `experiencia_tempo`) VALUES
	(8, 'Glaison Queiroz', 'glaison26.queiroz@gmail.com', '69551022653', 'm4662097', 'Rua da Intendencia 316 centro sabara', '1969-10-26', '(31) 98426-2508', '2 (duas)', 'Sim', 'Sim', '5 anos / 1.825 dias');

-- Copiando estrutura para tabela selecao.vs_nm
CREATE TABLE IF NOT EXISTS `vs_nm` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `cpf` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Copiando dados para a tabela selecao.vs_nm: ~1 rows (aproximadamente)
INSERT INTO `vs_nm` (`id`, `nome`, `email`, `cpf`, `rg`, `endereco`, `datanasc`, `telefone`, `curso_tecnico`, `graduacao`, `pos_graduacao`, `experiencia_tempo`) VALUES
	(3, 'Glaison Queiroz', 'glaison26.queiroz@gmail.com', '69551022653', 'm4662097', 'Rua da Intendencia 316 centro sabara', '1968-10-26', '(31) 4654-6546', 'Não', 'Não', 'Não', '1 ano / 365 dias');
