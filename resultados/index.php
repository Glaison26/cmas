...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    do {
        $c_senha = $_POST['senha'];
        if ($c_senha == 'cmas@2025')
            header('location: /cmas/resultados/lista.php');
        else {
            ...
            <form method="post">
                ...
                <div class="row mb-2">
                    ...
                    <div class="container -my5" class="row col-xs-12 col-sm-12 col-md-12 col-lg-12" align="left">
                        <br>
                        <button type="submit" class="btn btn-primary"><img src="\cmas\imagens\login.png" alt="" width="40" height="25"></span> Fazer login</button>
                        <hr>
                    </div>
