...
$c_candidato = $c_id;
$c_sql_foto1 = "SELECT organizacao.nome_osc, organizacao.apresentacao, organizacao.foto, organizacao.logo  FROM organizacao  where organizacao.nome_osc='$c_candidato'";
