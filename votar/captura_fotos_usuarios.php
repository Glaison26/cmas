...
$c_candidato = $c_id;
$c_sql_foto1 = "SELECT cadastro_usuarios.nome, cadastro_usuarios.foto FROM cadastro_usuarios  where cadastro_usuarios.nome='$c_candidato'";
...
header('location: /cmas/voto_usuario.php');
?>