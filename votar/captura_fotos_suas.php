...
$c_candidato = $c_id;
$c_sql_foto1 = "SELECT trabalhador_suas.nome, trabalhador_suas.apresentacao, trabalhador_suas.foto FROM trabalhador_suas  where trabalhador_suas.nome='$c_candidato'";
